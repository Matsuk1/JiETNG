...
TEXTS["web"]["settings"] = {
    ...
    "importTokenNotePlaceholder": "例：Bookmarklet / 外部ツール名",
    "importTokenNoteRequired": "Token名を入力してください。",
    "importTokenCreateLabel": "新しいToken",
    "importTokenCreateMeta": "生成後、Tokenは一度だけ表示されます。",
