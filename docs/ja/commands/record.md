...
13+sss progress   # 13+ 難易度 SSS 評価進捗（英語）
14AP progress 2   # 14 難易度 AP 評価進捗（2 ページ目）
...
- **完了**：目標評価を達成した譜面（1 ページあたり最大 35 個）
- **未完了**：目標評価に達していない譜面（1 ページあたり最大 15 個）
- 達成率の高い順にソート
- 最初のページには統計情報を表示（完了 / 未完了 / 未プレイ / 合計）
