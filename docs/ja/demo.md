  ...
  <div class="demo-card" v-if="!imageUrl">
    <form @submit.prevent="generate">
      ...
      <div class="params-section">
        <button type="button" class="params-toggle" @click="showParams = !showParams" :disabled="loading"><span>フィルターパラメーター（任意）</span><span class="params-arrow" :class="{ 'params-arrow--open': showParams }">&#9656;</span></button>
        ...
        <div class="param-field param-field--inline">
          <label>Next バージョン分組</label>
          <label class="next-toggle"><input type="checkbox" v-model="paramNext" :disabled="loading" />有効</label>
        </div>
        <div class="param-field param-field--inline">
          <label>ページ</label>
